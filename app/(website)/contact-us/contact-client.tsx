...
export const ContactClient = () => {
    ...
    const inputClasses = "w-full py-2.5 px-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors text-[14px] bg-white";

    return (
        <main className="min-h-[90vh] bg-gradient-to-br from-[#0a4699] via-[#0e74aa] to-[#25cdac] relative flex flex-col justify-center pt-24 pb-16 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
                <div className="flex flex-col lg:flex-row items-start gap-16 lg:gap-24 mb-16">
                    ...
                    <div className="lg:w-1/2 lg:pt-8">
                        ...
                        <div className="mt-12 text-white/90">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <a href="tel:+233241336367" className="flex items-center gap-3 hover:text-white transition-colors text-[#a6f7d4]">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                                    <span className="font-semibold text-lg text-white">+233 24 133-6367</span>
                                </a>
                    ...
                    <div className="lg:w-1/2 w-full max-w-lg">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-white rounded-[24px] p-6 md:p-8 shadow-2xl">
                                <h3 className="text-xl font-bold text-[#0a2540] mb-6 font-display">Let's get started</h3>
                                ...
                                {status === 'success' ? (
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        ...
                                        <button 
                                            ...
                                            className="w-full bg-[#00D4FF] hover:bg-[#00c0e6] text-[#0a2540] font-bold text-[14px] px-8 py-2.5 rounded-full transition-colors disabled:opacity-70"
                                        >
                ...
                <div className="bg-[#f0e6ff] rounded-full px-6 py-5 flex flex-col md:flex-row items-center justify-between text-[#0a2540] w-full shadow-lg">
                    ...
                    <a href="/products" className="font-bold text-[15px] text-[#8b3dff] hover:text-[#742ce0] transition-colors whitespace-nowrap">
