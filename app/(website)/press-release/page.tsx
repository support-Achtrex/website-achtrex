...
export default function PressReleasePage() {
 ...
 <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
 <p className="font-black text-slate-900">Strategic Partnerships</p>
 <a href="mailto:support@achtrex.com" className="text-[#00a9ce] font-medium hover:text-[#053787] transition-colors block mt-1">support@achtrex.com</a>
 </div>
 </div>
 </motion.div>
