...
export default function PressReleasePage() {
    ...
    return (
        <main className="pt-24 min-h-screen bg-white pb-20 font-sans text-[#111112]">
            
            {/* Header */}
            <div className="max-w-[1200px] mx-auto px-4 md:px-8 py-12 border-b border-gray-200">
                <nav className="flex items-center gap-2 text-sm text-gray-500 font-medium mb-6">
                    ...
                    <span className="text-[#111112]">Newsroom</span>
                </nav>
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <div className="mb-16">
                            ...
                            <Link href={`/press-release/${featuredPress.slug}`} className="group block">
                                <div className="relative h-[350px] md:h-[450px] w-full rounded-xl overflow-hidden mb-6 bg-gray-100">
                                    <Image
                        ...
                        {/* Latest News List */}
                        <div>
                            <h2 className="text-2xl font-bold mb-8 flex items-center gap-2 border-b border-gray-200 pb-4">
                            ...
                            <div className="flex flex-col gap-10">
                                {latestPress.map((press) => (
                                    <Link key={press.id} href={`/press-release/${press.slug}`} className="group grid grid-cols-1 md:grid-cols-4 gap-6 items-start">
                                        <div className="md:col-span-1 relative h-[140px] rounded-lg overflow-hidden bg-gray-100">
                                            <Image
                                                src={press.image}
                                                alt={press.title}
                                                fill
                            ...
                            <div className="mt-12 flex justify-center border-t border-gray-200 pt-12">
                    ...
                    <div className="lg:col-span-4 space-y-12">
                            ...
                            <div className="flex flex-col gap-3">
                                {categories.map((cat, idx) => (
                                    <label key={idx} className="flex items-center gap-3 cursor-pointer group">
                                        ...
                                        <span className={`text-[15px] ${idx === 0 ? 'font-bold text-[#111112]' : 'text-gray-600 group-hover:text-[#111112]'}`}>
                                            {cat}
                                        </span>
                                    </label>
                                ))}
                        ...
                        <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
                            ...
                            <div className="space-y-6">
                                <div>
                                    <p className="font-bold text-[#111112]">Achtrex Global Media Relations</p>
                                ...
                                <div className="pt-6 border-t border-gray-100">
                                    <p className="font-bold text-[#111112]">Investor Relations</p>
                        ...
                        <div className="bg-[#005AB0] p-8 rounded-xl text-white">
                            ...
                            <button className="flex items-center gap-2 bg-white text-[#005AB0] px-6 py-3 rounded-full font-bold hover:bg-gray-100 transition-colors w-full justify-center">
