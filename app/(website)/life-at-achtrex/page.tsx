...
export default function LifeAtAchtrexPage() {
 ...
 {/* Header */}
 <InnerPageHeader title="Architecting the Next Era of Data" subtitle="We engineer real infrastructure for the global automotive industry. Join a remote-first, pioneering team building AutomotiveDataset.com, AAIA, and the Achtrex Core." theme="cyan" />
