...
export default function AutomotiveClient() {
 ...
 <Image src="/projects/ad-real-screenshot-1.png" alt="Automotive Solutions" fill className="object-cover hover:scale-105 transition-transform duration-700" />
 </div>
 <div className="relative aspect-[4/3] overflow-hidden border border-slate-200 bg-white">
 <Image src="/projects/ad-real-screenshot-2.png" alt="Automotive Partner Solutions" fill className="object-cover hover:scale-105 transition-transform duration-700" />
 </div>
 <div className="relative aspect-[4/3] overflow-hidden border border-slate-200 bg-white">
 <Image src="/projects/ad-real-screenshot-3.png" alt="Automotive Developer Account" fill className="object-cover hover:scale-105 transition-transform duration-700" />
 </div>
 <div className="relative aspect-[4/3] overflow-hidden border border-slate-200 bg-white">
 <Image src="/projects/ad-real-screenshot-4.png" alt="Automotive Data Coverage" fill className="object-cover hover:scale-105 transition-transform duration-700" />
 </div>
 </div>
 </div>
