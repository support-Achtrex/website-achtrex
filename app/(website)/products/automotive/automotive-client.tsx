...
export default function AutomotiveClient() {
    return (
        <main className="min-h-screen bg-[#070b14] text-white selection:bg-[#174395] selection:text-white pt-24 pb-20">
            {/* 1. Header */}
            <div className="bg-gradient-to-br from-[#0c1222] to-[#174395]/20 border-b border-[#174395]/10 py-16 px-6">
                <div className="max-w-[1200px] mx-auto">
                    <nav className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#c2fce3]/60 mb-6 flex items-center gap-2">
                        ...
                        <span className="text-[#c2fce3]">Automotive Dataset</span>
                    </nav>
                    ...
                    <div className="flex gap-4">
                        <span className="px-4 py-1.5 rounded-full bg-[#070b14] border border-[#c2fce3]/20 text-[#c2fce3] text-sm font-semibold shadow-sm">Global Vehicle Data</span>
            ...
            <section className="py-12 lg:py-24 px-6">
                <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-24">
                    ...
                    <div className="lg:col-span-4 space-y-16">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-3 pt-2">
                                <a href="https://automotivedataset.com/pricing" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center w-full bg-[#111112] text-[#c2fce3] border border-white/10 font-semibold py-3 rounded-lg hover:bg-[#070b14] hover:border-[#c2fce3] hover:shadow-sm transition-all text-sm">
                                    View Pricing
                                </a>
                                <a href="https://automotivedataset.com/documentation" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center w-full bg-[#111112] text-[#c2fce3] border border-white/10 font-semibold py-3 rounded-lg hover:bg-[#070b14] hover:border-[#c2fce3] hover:shadow-sm transition-all text-sm">
                                    Read Docs
                                </a>
                                <a href="https://automotivedataset.com/developers" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center w-full bg-[#111112] text-[#F2147A] border border-white/10 font-semibold py-3 rounded-lg hover:bg-[#070b14] hover:border-[#F2147A] hover:shadow-sm transition-all text-sm">
                                    Developer Portal
                                </a>
                                <a href="https://automotivedataset.com/demo" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center w-full bg-[#111112] text-[#489EE6] border border-white/10 font-semibold py-3 rounded-lg hover:bg-[#070b14] hover:border-[#489EE6] hover:shadow-sm transition-all text-sm">
                                    Request Demo
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-8 space-y-24">
                        ...
                        >
                            <div className="relative aspect-[16/10] w-full rounded-[1.3rem] overflow-hidden bg-[#070b14]">
                                <Image 
                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 pt-16 mt-16 border-t border-white/10">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 gap-3">
                                    {[
                                        { name: 'Vehicle Imagery', link: 'https://automotivedataset.com/databases', color: 'text-[#c2fce3]' },
                                        { name: 'Basic YMM Specs', link: 'https://automotivedataset.com/databases', color: 'text-[#c2fce3]' },
                                        { name: 'Standard YMM Specs', link: 'https://automotivedataset.com/databases', color: 'text-[#c2fce3]' },
                                        { name: 'Advanced YMM Specs', link: 'https://automotivedataset.com/databases', color: 'text-[#c2fce3]' },
                                        { name: 'Market Valuations', link: 'https://automotivedataset.com/databases', color: 'text-[#c2fce3]' },
                                        { name: 'EV Specifications', link: 'https://automotivedataset.com/databases', color: 'text-[#c2fce3]' },
                                        ...
                                        <a key={i} href={item.link} target="_blank" rel="noreferrer" className="flex items-center gap-3 p-3 rounded-xl border border-white/10 bg-[#111112] hover:bg-[#070b14] hover:border-[#489EE6] hover:shadow-lg transition-all group">
                                            <Database className={`w-4 h-4 shrink-0 ${item.color}`} />
                                            <span className={`font-bold text-sm text-gray-200 group-hover:${item.color}`}>{item.name}</span>
