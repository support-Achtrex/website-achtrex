...
export const metadata: Metadata = {
 title: "AAIA Platform | Autonomous AI for Mobility",
 ...
 keywords: ["AAIA", "Automotive AI Agents", "Mobility AI Platform", "Autonomous Customer Service", "AI Lead Qualification", "Automotive Intelligence"],
 openGraph: {
 title: "AAIA Platform | Enterprise AI for Automotive",
