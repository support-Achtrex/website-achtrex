...
const PartnerForm = () => {
  ...
  const inputClasses = "w-full py-4 px-4 border border-slate-200 rounded-xl text-slate-900 focus:border-primary focus:ring-4 focus:ring-primary/5 outline-none transition-all bg-white text-base appearance-none";
  const labelClasses = "text-slate-700 text-sm font-bold mb-2 block group-focus-within:text-primary transition-colors";
  ...
  return (
    <section className="py-24 px-6 bg-slate-50 border-t border-slate-100">
      <div className="max-w-4xl mx-auto">
        ...
        <form className="space-y-6 bg-white p-8 md:p-10 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50" onSubmit={handleSubmit}>
