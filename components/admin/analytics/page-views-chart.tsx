  ...
  return (
    <div className="bg-transparent p-8 rounded-[32px] shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-slate-200/50 h-full hover:shadow-[0_10px_30px_rgba(0,0,0,0.04)] transition-all duration-300">
      <div className="flex items-center justify-between mb-8">
        <h3 className="font-bold text-slate-700 text-lg">Page Views</h3>
      ...
      <div className="flex items-end gap-4 mb-10">
        <span className="text-4xl font-bold text-gray-900 font-sans tracking-tight">645</span>
        <div className="flex items-center gap-1.5 text-red-500 mb-2 bg-red-50/80 px-2.5 py-1 rounded-full border border-red-100">
          ...
          <span className="text-sm font-bold font-sans">18%</span>
        </div>
      </div>
