...
const PagesTable = () => {
    ...
    return (
        <div className="bg-transparent p-8 rounded-[32px] shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-white/10/50  hover:shadow-[0_10px_30px_rgba(0,0,0,0.04)] transition-all duration-300">
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-1.5 bg-transparent/80 p-1.5 rounded-2xl border border-white/10">
