    ...
    <section className="py-24 px-6 bg-[image:var(--bg-dark-blue)] relative border-t border-white/5 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-slate-900">Our Core Values</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {values.map((value, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-900 group-hover:text-primary transition-colors">{value.title}</h3>
