 ...
 return (
  <section className="py-20 px-4 md:px-8 bg-[image:var(--bg-dark-purple)] border-t border-white/5 relative overflow-hidden">
   ...
   <div className="max-w-7xl mx-auto relative z-10">
    <h2 className="text-3xl md:text-4xl font-bold mb-12 text-slate-900">A Day in the Life</h2>
    ...
    <div className="grid md:grid-cols-3 gap-8">
     {activities.map((activity, index) => (
      ...
      >
       ...
       <h3 className="text-xl font-bold mb-3 text-slate-900 group-hover:text-primary transition-colors">{activity.title}</h3>
