...
export const InvoiceTemplate: React.FC<InvoiceTemplateProps> = ({ payment, client, logoSrc, paymentDetails }) => {
  ...
  return (
    ...
    >
      ...
      {isPaid && (
        <div
          className="absolute top-40 right-40 opacity-20 pointer-events-none rotate-[-15deg] border-4 font-black text-4xl px-4 py-2 rounded-lg uppercase tracking-widest z-0"
