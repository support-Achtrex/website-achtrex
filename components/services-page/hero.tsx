    ...
    <section className="relative min-h-[60vh] flex items-center justify-center py-20 px-4 overflow-hidden bg-[image:var(--bg-dark-teal)]">
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        <motion.div
          ...
          className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 rounded-full border border-slate-200 bg-transparent/5 backdrop-blur-sm"
        >
        ...
        <motion.h1
          ...
          className="text-4xl md:text-4xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-[#070b14] via-white/90 to-white/60 tracking-tight leading-tight"
        >
