...
export const StorySection = () => {
  return (
    <section className="py-32 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-1/4 -left-20 w-[800px] h-[800px] bg-[#00a9ce]/5 rounded-full blur-[128px] pointer-events-none" />
      <div className="absolute bottom-1/4 -right-20 w-[800px] h-[800px] bg-[#001a22]/5 rounded-full blur-[128px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-24">
          ...
          >
            ...
            <h2 className="text-4xl md:text-4xl font-bold text-slate-900 mb-8 leading-tight">
        ...
        <motion.div
          ...
          className="relative rounded-[2rem] overflow-hidden border border-slate-800 bg-[#001a22] text-white shadow-2xl"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-[#00a9ce]/10 via-transparent to-[#018861]/10 opacity-30" />
          <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#00a9ce]/50 to-transparent" />
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/10">
            <div className="p-12 md:p-16 flex flex-col justify-center md:col-span-2">
              <span className="text-[#00a9ce] text-sm font-bold tracking-widest uppercase mb-6 flex items-center gap-2">
            ...
            <div className="p-12 md:p-16 flex flex-col justify-center space-y-8 bg-black/20">
              <div>
                <h4 className="text-4xl font-bold text-white mb-1">50+</h4>
                <p className="text-sm text-[#00a9ce] uppercase tracking-wider font-bold">Systems Deployed</p>
              </div>
              <div>
                <h4 className="text-4xl font-bold text-white mb-1">99.9%</h4>
                <p className="text-sm text-[#00a9ce] uppercase tracking-wider font-bold">Uptime Reliability</p>
              </div>
              <div>
                <h4 className="text-4xl font-bold text-white mb-1">4yr</h4>
                <p className="text-sm text-[#00a9ce] uppercase tracking-wider font-bold">Tech Mastery</p>
              </div>
            </div>
          </div>
        </motion.div>
