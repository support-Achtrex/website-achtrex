...
export const AboutContent = () => {
    ...
    const platforms = [
        {
            ...
            border: 'border-[#e5e5e5] hover:border-sky-200',
            dot: 'bg-sky-500 shadow-[0_0_8px_rgba(14,165,233,0.4)]',
            statusText: 'text-sky-700',
            statusBg: 'bg-sky-100 border-sky-200',
        ...
        },
        {
            ...
            border: 'border-[#e5e5e5] hover:border-violet-200',
            dot: 'bg-violet-500 shadow-[0_0_8px_rgba(139,92,246,0.4)]',
            statusText: 'text-violet-700',
            statusBg: 'bg-violet-100 border-violet-200',
            name: 'LUMI AI',
        ...
        },
        {
            ...
            border: 'border-[#e5e5e5] hover:border-emerald-200',
    ...
    return (
        <div className="bg-[#f9fafb] text-[#111112] font-sans antialiased min-h-screen pb-16">
            
            {/* ─── HERO ─────────────────────────────────────────────────────── */}
            <div className="relative overflow-hidden pt-28 pb-10 px-6 border-b border-[#e5e5e5] bg-white">
                <div className="relative z-10 max-w-[1200px] mx-auto text-center flex flex-col items-center">
                    <h1 className="text-[40px] md:text-[56px] font-black tracking-[-0.03em] leading-[1] text-[#111112] mb-4">
                    ...
                    <div className="text-[14px] md:text-[15px] text-[#5C7695] max-w-4xl leading-relaxed font-medium mb-8 text-center space-y-4">
                        <p>
                    ...
                    <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-3 max-w-4xl">
                        {[
                            { n: '3', label: 'Live Platforms', color: 'bg-blue-50', border: 'border-blue-100' },
                            { n: '4+', label: 'Industries Served', color: 'bg-purple-50', border: 'border-purple-100' },
                            { n: 'SaaS', label: 'Business Model', color: 'bg-emerald-50', border: 'border-emerald-100' },
                            { n: 'Global', label: 'Remote Operations', color: 'bg-sky-50', border: 'border-sky-100' },
                        ].map((s, i) => (
                            <div key={i} className={`border ${s.border} rounded-2xl px-4 py-5 flex flex-col items-center justify-center relative overflow-hidden ${s.color}`}>
                                <p className="text-[28px] font-black text-[#111112] leading-none mb-1">{s.n}</p>
                                <p className="text-[10px] text-[#5C7695] font-bold uppercase tracking-wider">{s.label}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <div className="max-w-[1200px] mx-auto px-6 pt-10 flex flex-col gap-10">
                ...
                {/* ROW 1: Foundation (2x2 Grid) */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    {/* Mission */}
                    <div className="rounded-3xl bg-white border border-[#e5e5e5] p-8 shadow-sm flex flex-col hover:border-blue-300 transition-colors">

                        <h2 className="text-xl font-bold text-[#111112] mb-3">Our Mission</h2>
                        <p className="text-[14px] text-[#5C7695] leading-relaxed font-medium">
                    ...
                    {/* Vision */}
                    <div className="rounded-3xl bg-white border border-[#e5e5e5] p-8 shadow-sm flex flex-col hover:border-teal-300 transition-colors">

                        <h2 className="text-xl font-bold text-[#111112] mb-3">Our Vision</h2>
                        <p className="text-[14px] text-[#5C7695] leading-relaxed font-medium">
                    ...
                    {/* Fragmentation Gap */}
                    <div className="rounded-3xl border border-rose-200 p-8 bg-rose-50 hover:border-rose-300 transition-colors">
                        <div className="flex items-center gap-3 mb-4">

                            <h3 className="text-xl font-bold text-[#111112]">Industry Fragmentation</h3>
                        </div>
                        <ul className="space-y-3">
                            {[
                                ...
                                <li key={i} className="flex items-start gap-3 text-[14px] text-[#5C7695] font-medium">
                    ...
                    <div className="rounded-3xl border border-emerald-200 p-8 bg-emerald-50 hover:border-emerald-300 transition-colors">
                        <div className="flex items-center gap-3 mb-4">

                            <h3 className="text-xl font-bold text-[#111112]">The Achtrex Solution</h3>
                        </div>
                        <ul className="space-y-3">
                            {[
                ...
                {/* ROW 2: Platform Ecosystem */}
                <div className="flex flex-col gap-4">
                    <div className="px-2">
                        <h2 className="text-[20px] font-bold text-[#111112]">Platform Ecosystem</h2>
                    </div>
                            ...
                            <div key={i} className={`group flex flex-col rounded-3xl border ${p.bg} ${p.border} p-6 transition-all shadow-sm`}>
                                <div className="flex items-center justify-between mb-4">
                                    <div className="w-10 h-10 rounded-xl bg-white border border-[#e5e5e5] flex items-center justify-center shadow-sm">
                                        <span className="w-3 h-3 rounded-full shadow-inner" style={{ background: p.accent }} />
                                    </div>
                                    <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold border uppercase tracking-wider ${p.statusBg} ${p.statusText}`}>
                                        <span className={`w-1.5 h-1.5 rounded-full ${p.dot}`} />
                                        Live
                                    </span>
                                </div>
                                <h3 className="text-[16px] font-bold text-[#111112] mb-2">{p.name}</h3>
                                <p className="text-[13px] text-[#5C7695] leading-relaxed font-medium flex-1 mb-5">{p.desc}</p>
                ...
                {/* ROW 3: Leadership & Core Values */}
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
                    
                    {/* Leadership */}
                    <div className="lg:col-span-7 flex flex-col gap-4">
                        <div className="px-2">
                            <h2 className="text-[20px] font-bold text-[#111112]">Leadership</h2>
                        </div>
                        <div className="flex flex-col sm:flex-row gap-6 bg-white border border-[#e5e5e5] rounded-3xl p-6 shadow-sm h-full">
                            <div className="relative w-full sm:w-40 aspect-square sm:aspect-[4/5] shrink-0 rounded-2xl overflow-hidden bg-[#e5e5e5]">
                                <Image src="/team/achim_real.jpg" alt="Godwin Achim Tetteh" fill className="object-cover" />
                            </div>
                            <div className="flex flex-col justify-center">
                                <h3 className="text-lg font-bold text-[#111112]">Godwin Achim Tetteh</h3>
                                <p className="text-[11px] font-bold uppercase tracking-wider text-blue-600 mb-3">Founder & System Architect</p>
                                <div className="text-[13px] text-[#5C7695] leading-relaxed font-medium mb-4 space-y-3">
                                    <p>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {expertise.map((t, i) => (
                                        <span key={i} className="px-2.5 py-1 rounded-lg text-[10px] font-bold bg-blue-50 text-blue-700 border border-blue-100">
                                            {t}
                                        </span>
                                    ))}
                                </div>
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-4">
                        <div className="px-2">
                            <h2 className="text-[20px] font-bold text-[#111112]">Core Values</h2>
                        </div>
                        <div className="grid grid-cols-2 gap-3 h-full">
                            {values.map((v, i) => (
                                <div key={i} className="flex flex-col items-center justify-center gap-2 p-4 rounded-2xl border border-[#e5e5e5] bg-white hover:bg-blue-50 transition-colors shadow-sm text-center">
                                    <span className="text-xl text-blue-500 leading-none font-mono drop-shadow-sm">{v.icon}</span>
                                    <span className="text-[12px] font-bold text-[#5C7695]">{v.label}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                {/* CTA */}
                <div className="relative rounded-3xl bg-gradient-to-r from-blue-50 via-teal-50 to-emerald-50 border border-[#e5e5e5] overflow-hidden shadow-sm mt-2">
                    <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6 p-8 md:p-10 text-center sm:text-left">
                        <div>
                            <h2 className="text-[24px] font-black text-[#111112] mb-2 tracking-tight">Ready to build on Achtrex?</h2>
                            <p className="text-[14px] text-[#5C7695] font-medium">
                        ...
                        <Link href="/contact-us" className="inline-flex items-center gap-2 bg-[#111112] text-white font-bold text-[14px] px-6 py-3 rounded-full hover:bg-gray-800 transition-all shadow-md shrink-0">
                            Get in touch
