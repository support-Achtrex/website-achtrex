  ...
  return (
    <div className="bg-transparent text-slate-900 font-sans antialiased min-h-screen pb-16">
      ...
      <div className="max-w-[1200px] mx-auto px-6 pt-4 pb-10">
        <div className="relative w-full aspect-[21/9] rounded-none overflow-hidden border border-slate-200 shadow-sm group">
          <Image 
            ...
            unoptimized
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#001a22]/80 via-transparent to-transparent opacity-80" />
          <div className="absolute bottom-6 left-8">
            <p className="text-white font-bold text-lg">Engineering the Future</p>
            <p className="text-[#00a9ce] text-sm font-bold tracking-wider uppercase">Achtrex HQ</p>
          </div>
        </div>
      </div>
