...
const ContactForm = () => {
 ...
 const inputClasses = "w-full py-4 px-4 border border-slate-200 rounded-none text-slate-900 focus:border-[#00a9ce] outline-none transition-colors bg-white text-base appearance-none shadow-sm";
 const labelClasses = "text-slate-500 text-xs font-bold uppercase tracking-wider mb-2 block group-focus-within:text-[#00a9ce] transition-colors";

 return (
  <section id="contact" className="py-24 px-6 bg-[#f4f4f4] border-t border-b border-slate-200 relative overflow-hidden">
     ...
     >
      ...
      {status === 'success' && (
       <div className="flex flex-col gap-2">
        <p className="text-[#76bc1d] font-bold text-sm bg-[#76bc1d]/10 px-4 py-2 rounded-none border border-[#76bc1d]/20">Request submitted. Our technical team will follow up quickly.</p>
