        ...
        <section id="why-achtrex" className="py-16 px-6 relative overflow-hidden bg-transparent">
            <div className="max-w-[1440px] mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10 max-w-5xl mx-auto">
                    {[
                        ...
                        <motion.div 
                            ...
                            className="text-center p-6 rounded-2xl border border-white/10 bg-[#111112] hover:border-[#1A8B8C]/50 hover:bg-[#1a1a1c] transition-all">
                ...
                <motion.div 
                    ...
                    className="w-full relative h-[240px] md:h-[380px] rounded-2xl overflow-hidden border border-white/10 shadow-sm mb-10">
                    <Image
