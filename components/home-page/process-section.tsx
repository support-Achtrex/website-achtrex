        ...
        <section className="py-20 px-6 bg-background relative overflow-hidden text-left border-y border-white/5">
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-16 space-y-3">
                    <span className="text-primary text-sm font-bold tracking-widest uppercase block">SaaS Go-To-Market</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {processes.map((process, index) => (
                        <motion.div
                            ...
                            className="bg-slate-900 border border-white/10 p-8 rounded-2xl relative group hover:bg-slate-800 transition-all hover:border-primary/50"
                        >
                            ...
                            <div className="w-12 h-12 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-xl flex items-center justify-center text-primary mb-5 group-hover:scale-110 transition-transform duration-300">
