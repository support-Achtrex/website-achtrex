    ...
    <section id="products" className="py-32 bg-[#030014] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mb-20 text-center lg:text-left">
          ...
          <h2 className="text-4xl md:text-4xl font-bold text-gradient mb-6">Our Internal Products</h2>
        </div>
            ...
            <AnimatePresence mode='wait'>
              ...
              >
                ...
                <div className="order-2 lg:order-1 flex flex-col justify-center">
                  ...
                  <h3 className="text-4xl md:text-4xl font-bold text-gradient mb-4" style={{ color: products[currentIndex].color }}>
