...
export const Hero = () => {
    ...
    return (
        <div className="relative">
            <section id="home" className="relative min-h-[450px] lg:h-[550px] flex items-center bg-[#0a0f1c] overflow-hidden">
                ...
                <div className="absolute right-0 top-0 bottom-0 w-full lg:w-1/2 z-0">
                    <div className="relative w-full h-full">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-r from-[#0a0f1c] via-[#0a0f1c]/40 to-transparent z-10" />
                    ...
                    <div className="w-full xl:max-w-2xl pointer-events-auto">
                        ...
                        <div className="flex gap-4">
                            <button
                                ...
                                className="bg-gradient-to-r from-white via-[#10b981] to-[#3b82f6] hover:opacity-90 text-black px-8 py-3.5 font-bold text-sm transition-all inline-block tracking-wide shadow-xl"
                            >
                                Get Started
                            </button>
                            <button
                                onClick={() => router.push('/about-us')}
                                className="bg-transparent hover:bg-white/5 text-white border border-white/20 px-8 py-3.5 font-bold text-sm transition-colors inline-block tracking-wide"
                            >
                                Our Company
                            </button>
                        </div>
