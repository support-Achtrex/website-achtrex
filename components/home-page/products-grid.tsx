        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <a href="https://automotivedataset.com" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-b from-[#eaf4fe] to-[#f2f7fe] rounded-[32px] p-8 relative overflow-hidden group cursor-pointer border border-[#e5e5e5] h-[450px] shadow-sm hover:shadow-md transition-shadow block">
              ...
              {/* Mockup UI */}
              <div 
                className="absolute bottom-10 left-1/2 -translate-x-1/2 w-[90%] max-w-[360px] bg-white rounded-[24px] shadow-[0_15px_50px_rgba(0,0,0,0.12)] p-6 transition-transform duration-500 group-hover:scale-105 flex justify-center items-center border-[6px] border-transparent"
                style={{ background: 'linear-gradient(white, white) padding-box, conic-gradient(from 0deg, #2563eb, #8b5cf6, #ec4899, #38bdf8, #2563eb) border-box' }}
              >
                ...
                <div className="flex items-center gap-5 my-2">
                  ...
                  {/* Text */}
                  <div className="flex flex-col text-[#214b8c] font-bold leading-[1.05] tracking-tight">
                     <span className="text-[30px]">Automotive</span>
                     <span className="text-[30px]">Dataset</span>
                  </div>
            ...
            <Link href="/products/lumi" className="bg-gradient-to-b from-[#eaf4fe] to-[#f2f7fe] rounded-[32px] p-8 relative overflow-hidden group cursor-pointer border border-[#e5e5e5] h-[450px] shadow-sm hover:shadow-md transition-shadow block">
              ...
              {/* Mockup UI */}
              <div className="absolute bottom-12 left-1/2 -translate-x-1/2 w-[240px] h-[240px] bg-white rounded-full shadow-[0_10px_40px_rgba(0,0,0,0.08)] flex flex-col items-center justify-center border-[8px] border-transparent transition-transform duration-500 group-hover:scale-105" style={{ background: 'linear-gradient(white, white) padding-box, conic-gradient(from 180deg, #ec4899, #8b5cf6, #3b82f6, #ec4899) border-box' }}>
                
                {/* LUMI Logo Scaled Up */}
                <div className="flex flex-col items-center gap-4 mt-2">
                  <div className="relative w-24 h-24 rounded-full bg-gradient-to-br from-[#38bdf8] via-[#6366f1] to-[#a855f7] flex items-center justify-center shadow-md">
                    <div className="relative w-[60px] h-[60px] bg-white rounded-full flex items-center justify-center">
                       {/* Tail */}
                       <div className="absolute -bottom-[2px] -left-[2px] w-[22px] h-[22px] bg-white rounded-bl-[6px] transform rotate-12"></div>
                       {/* Dots */}
                       <div className="flex gap-[6px] z-10 relative left-[2px]">
                          <div className="w-[9px] h-[9px] rounded-full bg-[#3b82f6]"></div>
                          <div className="w-[9px] h-[9px] rounded-full bg-[#6366f1]"></div>
                          <div className="w-[9px] h-[9px] rounded-full bg-[#a855f7]"></div>
                       </div>
                    </div>
                  </div>
                  <span className="text-[44px] font-bold tracking-wide text-[#282a65] leading-none">LUMI</span>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="https://automotivedataset.com" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-b from-[#e3fcf7] to-[#eefcf9] rounded-[32px] p-8 relative overflow-hidden group cursor-pointer border border-[#e5e5e5] h-[400px] shadow-sm hover:shadow-md transition-shadow block">
              ...
              <div className="absolute bottom-[20px] left-1/2 -translate-x-1/2 w-[85%] max-w-[280px] bg-white rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.08)] border border-[#e5e5e5] p-5 transition-transform duration-500 group-hover:-translate-y-2">
                 <div className="flex items-center justify-between border-b border-gray-100 pb-3 mb-4">
                    <div className="text-[12px] font-bold text-[#111112] flex items-center gap-1.5">
                    ...
                    <div className="text-[10px] font-bold text-green-500 bg-green-50 px-2 py-0.5 rounded-full">Live</div>
                 </div>
                 
                 <div className="space-y-3">
                    <div className="flex justify-between items-center group/item">
                       <div className="text-[11px] font-semibold text-[#5C7695] group-hover/item:text-blue-600 transition-colors flex items-center gap-2">
            ...
            <Link href="/products" className="bg-gradient-to-b from-[#f0f2fb] to-[#f4f6fc] rounded-[32px] p-8 relative overflow-hidden group cursor-pointer border border-[#e5e5e5] h-[400px] shadow-sm hover:shadow-md transition-shadow block">
              ...
              <div className="absolute bottom-[-10px] left-1/2 -translate-x-1/2 w-[85%] max-w-[280px] bg-white rounded-t-[24px] shadow-[0_-15px_40px_rgba(0,0,0,0.08)] border border-[#e5e5e5] border-b-0 p-6 transition-transform duration-500 group-hover:-translate-y-2">
                 
                 <div className="flex justify-between items-center mb-6">
                    <div className="flex items-center gap-2 font-bold text-[13px] text-[#111112]">
                 ...
                 <div className="bg-[#f9fafb] border border-gray-100 rounded-xl p-4 mb-4">
                     <div className="text-[11px] font-semibold text-gray-400 mb-3 uppercase tracking-wider">Route Request To:</div>
                     
                     <div className="flex flex-col gap-2">
                        <div className="bg-white border border-blue-100 rounded-lg p-2.5 flex items-center justify-between shadow-sm group/route cursor-pointer">
                           <div className="flex items-center gap-2">
                              ...
                              <span className="text-[11px] font-bold text-[#111112]">Automotive Dataset</span>
                           </div>
                           <span className="text-[9px] font-mono text-gray-400 bg-gray-100 px-1.5 rounded">Data</span>
                        </div>

                        <div className="bg-white border border-purple-100 rounded-lg p-2.5 flex items-center justify-between shadow-sm group/route cursor-pointer">
                           <div className="flex items-center gap-2">
                              ...
                              <span className="text-[11px] font-bold text-[#111112]">LUMI AI</span>
                           </div>
                           <span className="text-[9px] font-mono text-gray-400 bg-gray-100 px-1.5 rounded">Intelligence</span>
                        </div>
                     </div>
                 </div>

                 <div className="bg-[#111112] text-white text-[13px] font-bold rounded-xl py-3 text-center shadow-lg cursor-pointer hover:bg-gray-800 transition-colors">
                    Generate API Keys
                 </div>
              </div>
            </Link>
