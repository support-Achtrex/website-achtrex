        ...
        <div className="w-full bg-[#f8fafc] min-h-screen">
                ...
                <div className="max-w-[1000px] mx-auto bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-8 md:p-12">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {data.stats.map((stat, idx) => (
                            ...
                            >
                                <div className="flex items-center justify-center text-4xl md:text-5xl font-black text-[#11243b] mb-2">
                                    {stat.value}
            ...
            <section className="w-full py-24 px-6 bg-white">
                <div className="max-w-[1200px] mx-auto text-center">
                    <h2 className="text-4xl md:text-5xl font-black text-[#11243b] mb-16">The Outcome</h2>
