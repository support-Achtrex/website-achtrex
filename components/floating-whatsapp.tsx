    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
      ...
      <div className="relative group">
        ...
        <a
          ...
          aria-label="Direct Call (+971 50 222 9587)"
        >
      ...
      <div className="relative group">
        ...
        >
          ...
          <svg width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="animate-[wiggle_1s_ease-in-out_infinite] [animation-delay:400ms]">
            <path 
              fill="currentColor" 
      ...
      <div className="relative group">
        ...
        <a
          ...
          className="relative flex h-9 w-9 items-center justify-center rounded-full bg-[#018861] text-white shadow-xl transition-transform duration-300 ease-in-out hover:scale-125 hover:rotate-12 active:scale-90"
          aria-label="Email us"
        >
          <Mail className="w-4 h-4 animate-[wiggle_1s_ease-in-out_infinite] [animation-delay:800ms]" />
        </a>
      </div>
    </div>
  );
