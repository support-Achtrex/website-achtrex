export const pressReleases = [
    {
        id: '1',
        slug: 'achtrex-launches-lumi-ai',
        title: 'Achtrex Announces AAIA: The Autonomous AI Agent for the Automotive Ecosystem',
        date: 'May 15, 2026',
        ...
        content: `
          ...
          <p class="mb-6 text-slate-700 leading-relaxed">
            <strong>NEW YORK, NY, May 15, 2026,</strong> Achtrex, the global leader in enterprise automotive data infrastructure and cognitive AI platforms, today announced a major step forward with its latest initiative. AAIA, the first fully autonomous cognitive engine for the automotive sector, is now generally available for enterprise partners.
          </p>
          <p class="mb-6 text-slate-700 leading-relaxed">
            Unlike standard LLMs which frequently hallucinate technical vehicle specifications, AAIA is deterministically tethered to Achtrex's massive proprietary data graph, meaning it relies on factually sound API responses. 
          </p>
          <blockquote class="border-l-4 border-[#00a9ce] pl-6 my-10 italic text-xl text-slate-800 font-medium">
          ...
          <p class="mb-6 text-slate-700 leading-relaxed">
            The AAIA infrastructure is currently being integrated across the largest dealer management systems in North America, streamlining everything from lead qualification to complex parts identification.
          </p>
          <h3 class="text-2xl font-bold mt-12 mb-4">About Achtrex</h3>
    ...
    {
        id: '2',
        slug: 'achtrex-expands-european-data-centers',
        title: 'Achtrex Expands Global Telemetry Network with New European Edge Data Centers',
        date: 'April 02, 2026',
    ...
    {
        id: '5',
        slug: 'achtrex-appoints-new-head-of-ai',
        title: 'Achtrex Strengthens Leadership Team with New Head of Artificial Intelligence',
