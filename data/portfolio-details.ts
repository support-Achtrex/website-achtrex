export const portfolioDetails = {
    ...
    "lumi-ai": {
        ...
        stats: [
            ...
            { value: "24/7", suffix: "", label: "Availability" },
            { value: "1M", suffix: "+", label: "Conversations" }
        ],
        challenge: "Building a proprietary AI engine capable of understanding complex vehicle diagnostics and routing automated customer support seamlessly.",
        scope: [
            "Natural Language Processing Models",
            "Automotive Ontology Mapping",
            "Integration with Achtrex Core",
            "Real-time Diagnostic Inference"
        ],
        outcomes: [
            { title: "AI Interface", image: "/ai_car_hero.png" },
            { title: "Logic Engine", image: "/ai_car_hero_new.png" }
        ]
    },
    "achtrex-core": {
        title: "Achtrex Core",
        kicker: "Foundational Integration Hub",
        heroImage: "/achtrex-logo-email.png",
        stats: [
        ...
        outcomes: [
            { title: "Command Center", image: "/enterprise_command_center.png" },
            { title: "System Architecture", image: "/server_infrastructure.png" }
        ]
    },
    "ark-auto-shop": {
        title: "Ark Auto Shop",
        kicker: "Digital Parts Distribution",
        heroImage: "/logos/use-cases/arkauto.png",
        stats: [
            { value: "300", suffix: "%", label: "Sales Growth" },
            { value: "50", suffix: "K", label: "Parts Indexed" },
            { value: "100", suffix: "%", label: "Fitment Accuracy" },
            { value: "2", suffix: "x", label: "Faster Checkout" }
        ],
        challenge: "Ark Auto Shop required a complete digital overhaul to manage their vast inventory and ensure perfect fitment technologies for their customers.",
        scope: [
            "E-commerce Platform Development",
            "Intelligent Fitment Algorithm",
            "AI-powered Search",
            "Inventory Management System"
        ],
        outcomes: [
            { title: "E-Commerce Website", image: "/hero-bg-tech.png" },
            { title: "Mobile Experience", image: "/hero-bg-team.png" }
        ]
    },
    "carkasa": {
        title: "Carkasa",
